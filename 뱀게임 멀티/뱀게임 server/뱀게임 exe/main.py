...
while True:
   ...
   for event in events:
      ...
      if event.type == pygame.KEYDOWN:  # 화살표 키가 입력되면 뱀의 방향을 바꾼다
         ...
         if event.key == pygame.K_f:                 #속도늘리기===================================================
            timeChange = timeChange/2
            exec('TURN_INTERVAL = timedelta(seconds={})'.format(timeChange))
         if event.key == pygame.K_c:
            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            RED = randomR, randomG, randomB
            
            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            GREEN = randomR, randomG, randomB

            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            WHITE = randomR, randomG, randomB

            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            BLUE = randomR, randomG, randomB
             
            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            GRAY = randomR, randomG, randomB

            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            BLACK = randomR, randomG, randomB

            randomR = random.randint(0,255)
            randomG = random.randint(0,255)
            randomB = random.randint(0,255)
            TEXTCOLOR = randomR, randomG, randomB
